...
describe('Styles and Sizes tests', () => {
  it('should render style icons', () => {
    render(<StylesAndSizes setCurrentStyle={() => { }} name="test" productStyles={sampleStyles} currentStyle={0} />);
  ...
  it('should render an icon even if style url is missing', () => {
    render(<StylesAndSizes setCurrentStyle={() => { }} name="test" productStyles={SampleStylesNoURL} currentStyle={0} />);
